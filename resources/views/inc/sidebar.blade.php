    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('admin.pengalamans.index')}}">Pengalaman</a>
                <a class="collapse-item" href="{{route('admin.pendidikans.index')}}">Pendidikan</a>
                <a class="collapse-item" href="{{route('admin.skills.index')}}">Skill</a>
